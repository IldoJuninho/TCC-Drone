...
while True:
	...
	if webCamera.isOpened(): 
		...
		for(x, y, l, a) in detecta:
			...
			cv2.line(frame, (int(0), int(height+height*0.4)), (int(width*2), int(height+height*0.4)), vermelho, 2)
			cv2.line(frame, (int(0), int(height-height*0.4)), (int(width*2), int(height-height*0.4)), vermelho, 2)
			cv2.line(frame, (int(width+width*0.3), int(height*2)), (int(width+width*0.3), int(0)), azul, 2)
			cv2.line(frame, (int(width-width*0.3), int(height*2)), (int(width-width*0.3), int(0)), azul, 2)
